...
// import { ArrowLeftRight, Calendar, Search, X, ArrowLeft, Clock, ChevronDown, Plane, Check } from "lucide-react"
...
//   { id: "2", airline: "Lufthansa", flightNumber: "AT 4534", departure: "11:45 PM", arrival: "6:45 AM", duration: "4h 10min", stops: "2 stops", price: "AED 2,456.90", date: "+1 day" },
//   { id: "3", airline: "Emirates", flightNumber: "AT 4324", departure: "9:45 AM", arrival: "11:45 AM", duration: "7h 10min", stops: "1 stop", price: "AED 1,456.90", date: "Thu 29 Jun" },
//   { id: "4", airline: "Emirates", flightNumber: "AT 4324", departure: "11:45 PM", arrival: "6:45 AM", duration: "19h 10min", stops: "1 stop", price: "AED 1,456.90", date: "Sat 2 Jul" },
//   { id: "5", airline: "Lufthansa", flightNumber: "AT 4324", departure: "9:45 AM", arrival: "11:45 AM", duration: "7h 10min", stops: "Non stop", price: "AED 1,456.90", date: "Thu 29 Jun" },
//   { id: "6", airline: "Lufthansa", flightNumber: "AT 4324, Indigo • 6E 783", departure: "11:45 PM", arrival: "6:45 AM", duration: "4h 10min", stops: "Non stop", price: "AED 1,456.90", date: "Thu 29 Jun" },
// ]
...
//           <div className="text-sm font-medium text-gray-400">CDG - DXB</div>
...
//           <LoadingStep
//             label="Searching 400+ flights"
//             isComplete={searchProgress >= 33}
//             isInProgress={searchProgress < 33}
//           />
//           <LoadingStep
//             label="Attaching company rules"
//             isComplete={searchProgress >= 66}
//             isInProgress={searchProgress >= 33 && searchProgress < 66}
//           />
//           <LoadingStep
//             label="Serving best results"
//             isComplete={searchProgress >= 100}
//             isInProgress={searchProgress >= 66 && searchProgress < 100}
//           />
//         </div>
//       </CardContent>
//     </Card>
...
//   <div className="flex justify-between items-center border-b border-gray-700 py-4 hover:bg-gray-800 transition-colors duration-200">
//     <div className="flex items-center space-x-4">
//       <img src={`/placeholder.svg?height=32&width=32`} alt={flight.airline} className="w-8 h-8" />
//       <div>
...
//     </div>
//     <Button className="bg-teal-700 hover:bg-teal-600 text-white" onClick={onSelect}>Select</Button>
//   </div>
// )

// const FlightDetails = ({ details, onBack }: { details: FlightDetails; onBack: () => void }) => (
//   <Card className="w-full max-w-4xl mx-auto bg-gray-900 border-gray-800">
//     <CardContent className="p-6 space-y-6">
//       <div className="flex items-center justify-between">
//         <div className="flex items-center space-x-2">
//           <Button variant="ghost" size="icon" onClick={onBack} className="text-gray-400 hover:text-gray-300">
...
//       </div>
//       {[details.outbound, details.inbound].map((flight, index) => (
//         <div key={index} className="bg-gray-800 rounded-lg p-4 space-y-4">
//           <div className="flex justify-between items-center">
//             <p className="font-medium text-gray-300">{flight.date}</p>
//             <p className="text-sm text-gray-400">{flight.duration}</p>
//           </div>
//           <div className="flex justify-between items-center">
//             <div className="space-y-1">
//               <p className="text-2xl font-bold text-gray-200">{flight.departureTime}</p>
//               <p className="font-medium text-gray-300">{flight.from.split('•')[0].trim()}</p>
//               <p className="text-sm text-gray-400">{flight.from.split('•')[1].trim()}</p>
//             </div>
//             <Plane className="text-teal-500 rotate-90" size={24} />
//             <div className="space-y-1 text-right">
//               <p className="text-2xl font-bold text-gray-200">{flight.arrivalTime}</p>
//               <p className="font-medium text-gray-300">{flight.to.split('•')[0].trim()}</p>
//               <p className="text-sm text-gray-400">{flight.to.split('•')[1].trim()}</p>
//             </div>
//           </div>
...
//           Layover: {details.layover.duration}
//         </div>
//       )}
//     </CardContent>
//   </Card>
...
// const AirportSelect = ({ value, onChange, label, placeholder }: { value: string; onChange: (value: string) => void; label: string; placeholder: string }) => (
//   <div className="space-y-2">
...
//   const [dates, setDates] = useState("Jun 25 - Jul 2")
...
//           <h1 className="text-2xl font-semibold text-center mb-6 text-gray-200">Good afternoon, Brian</h1>
...
//             <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
//               <div className="space-y-2">
//                 <Label htmlFor="dates" className="text-gray-300">Dates</Label>
...
//       {!showResults && !showFlightDetails && <LandingPage />}
//       {showResults && !showFlightDetails && <SearchResults />}
//       {showFlightDetails && (
//         <div className="min-h-screen bg-gray-900 p-4">
//           <FlightDetails details={sampleFlightDetails} onBack={handleBackToResults} />
//         </div>
//       )}
...
//   switch (airline) {
//     case 'Emirates':
//       return '/images/emirates-logo.png'; // Adjust the path if needed
//     case 'Lufthansa':
//       return '/images/lufthansa-logo.png'; // Adjust the path if needed
//     default:
//       return '/placeholder.svg'; // Default logo if not found
//   }
// };
...
//         >
//           {value
//             ? airports.find((airport) => airport.code === value)?.city || placeholder
//             : placeholder}
...
//   const [from, setFrom] = useState('');
//   const [to, setTo] = useState('');
//   const [dates, setDates] = useState<Date | null>(null); // Updated to use Date type
//   const [searchProgress, setSearchProgress] = useState(0);
...
//       try {
//         const response = await fetch('/airports.json'); // Adjust this if the path is different
//         const data = await response.json();
//         console.log('Fetched airports:', data.airports);
